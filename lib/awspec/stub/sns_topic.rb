...
OWNER = '123456789'
REGION = 'us-east-1'
TOPIC_ARN = "arn:aws:sns:#{REGION}:#{OWNER}:foobar".freeze
DISPLAY_NAME = 'Useless'
SUBSCRIBED = "arn:aws:sns:#{REGION}:#{OWNER}:Foobar:3dbf4999-b3e2-4345-bd11-c34c9784ecca".freeze
ENDPOINT = "arn:aws:lambda:#{REGION}:#{OWNER}:function:foobar".freeze
