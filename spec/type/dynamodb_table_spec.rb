...
describe dynamodb_table('my-dynamodb-table') do
  ...
  it { should have_attribute_definition('my-dynamodb-table-attribute1').attribute_type('S') }
  it { should have_attribute_definition('my-dynamodb-table-attribute2').attribute_type('N') }
